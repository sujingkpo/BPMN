var UI = {
    init: function () {
        ...
        if (cateType == "network") {
            $("#export_svg, #export_pdfHD").attr("disabled", "true").disable();
            $("#export_svg, #export_pdfHD").next().css({
                opacity: 0.4
            })
        }
    },
    ...
    showAddColla: function () {
        ...
        var a = "";
        $("#input_add_colla").val("").unbind().bind("keyup",
        function () {
            var c = $(this).val();
            if (c == a) {
                return
    ...
    showShapesManage: function () {
        ...
        function (b) {
            ...
            for (var d = 0; d < b.length; d++) {
                var e = b[d];
                if ((CategoryMapping.network && e == "network") || (CategoryMapping.aws_analytics && e == "network_aws") || (CategoryMapping.cisco_bulidings && e == "network_cisco") || (CategoryMapping.azure && e == "network_azure")) {
                    f = true;
                    break
                }
