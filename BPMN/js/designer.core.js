...
var Designer = {
    ...
    op: {
        ...
        linkDashboard: function (d) {
            ...
            if ($("#panel_" + a).length != 0) {
                ...
                e.find(".link_shape_icon").unbind().bind("mousedown",
                function (n) {
                    n.stopPropagation();
                    ...
                    Designer.op.groupDashboard(m, l, k,
                    function (q) {
                        g(q);
                        e.hide();
                ...
                e.children(".dashboard_box").unbind().bind("click",
                function () {
                    e.hide();
                    $(document).unbind("mousedown.dashboard");
                    var l = $(this);
    ...
    painter: {
        ...
        renderShape: function (i) {
            ...
            l.lineJoin = "round";
            this.renderShapePath(l, i, false,
            function () {
                var o = i.id;
